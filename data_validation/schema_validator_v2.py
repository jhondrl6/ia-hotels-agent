...
SCHEMA_HOTEL_COVERAGE = {
    ...
    "critical_for_rich_results": ["image", "aggregateRating", "geo"],
    "recommended": [
        "starRating",
        "openingHours",
        "paymentAccepted",
...
class SchemaValidatorV2:
    ...
    def analyze(self, html_content: str, url: str) -> SchemaAnalysis:
        ...
        return SchemaAnalysis(
            ...
            has_hotel_schema=schema_type == "Hotel",
    ...
    def detect_schema_type(self, schemas: List[Dict[str, Any]]) -> str:
        ...
        Returns:
            str: "Hotel", "Organization", "LocalBusiness", o "Unknown".
        """
        # Prioridad de tipos: Hotel > LocalBusiness > Organization
        type_priority = ["Hotel", "LocalBusiness", "Organization"]
