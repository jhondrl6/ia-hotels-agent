...
| `modules/asset_generation/conditional_generator.py` | hotel_schema con datos reales + faq_page JSON-LD | FASE-2, FASE-5 |
...
| modules/asset_generation/conditional_generator.py | _generate_hotel_schema() + _generate_faq_page() |
