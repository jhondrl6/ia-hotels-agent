...
**Estado: FASE-G CERRADA el 2026-09-20 (primera sesión con código de producto; trabajo en el árbol de trabajo, sin commit autorizado); 0–RELEASE pendientes.** **Contador v4complete: 0/1. Siguiente sesión: FASE-0.**
...
| 2 · [G](05-prompt-inicio-sesion-fase-G.md) | Descubrimiento AST de callers y retirada del contrato muerto. **Adelantado: es el guard de las ediciones de B–F** | ALTA: cobertura sin lista fija y firmas compartidas | **CERRADA 2026-09-20** (sin commit autorizado) |
