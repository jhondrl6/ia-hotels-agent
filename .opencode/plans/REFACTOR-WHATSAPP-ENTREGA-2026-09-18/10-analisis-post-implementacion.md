...
Sin lecciones **post-implementación**: ninguna fase se ha ejecutado. Las seis filas siguientes son lecciones de **preparación** (2026-09-18 y 2026-09-19), sustentadas en mediciones reales de lectura —código vivo, evidencia archivada de FASE-P4 y el sitio público del hotel—, y se registran aquí para que VERIFY las contraste contra lo ejecutado, no para darlas por certificadas.
...
| Procedencia del dato del hotel (L-ENT.3, L-ENT.6) | ABIERTO, detectado en preparación | Datos/procedencia + operador | Valor gobernante declarado con productor; fixture corregido desde ahí y consentimiento re-emitido datado sobre la URL viva antes de consumir el intento |
