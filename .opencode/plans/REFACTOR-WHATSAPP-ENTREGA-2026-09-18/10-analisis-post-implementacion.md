...
| A | Nueva sesión | PENDIENTE | Por medir | Solo recuperación independiente de evidencia | Contratos y prerrequisitos; ratifica FASE-0 y AC19a/AC19b |
| G | Nueva sesión | PENDIENTE | Por medir | Inventarios read-only | **Segunda sesión** en el orden revisado: verificador AST como guard |
...
|---|---|---|---|---|---|
| AC1–AC20 | Ver `01-plan-maestro.md` | Contratos del maestro | Sin medición post | Sin artefactos nuevos | PENDIENTE |
