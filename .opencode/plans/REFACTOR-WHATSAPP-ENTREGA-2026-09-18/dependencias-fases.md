...
Fuentes de contrato: [maestro](01-plan-maestro.md), [ejecución](04-contrato-ejecucion.md) y [lecciones](00-lecciones-capitalizadas.md). **FASE-A ejecutada el 2026-09-19 (documental, HEAD `d4dacb4`) y cerrada en checkpoint por autorización de commit. Contador v4complete: 0/1. Siguiente sesión: G, y su arista sigue cerrada hasta que el cierre de A se commitee.**
...
|---|---|---|---|---|
| A | Mandato de sesión y fuentes del plan | Baseline y contratos ratificados, **incluida FASE-0, la división AC19a/AC19b y el re-anclaje de la meta E2E**; permisos centrales, identidad y vigencia resueltos o checkpoint explícito | 0 | **EJECUTADA 2026-09-19 — condición de salida cumplida salvo el commit**: matriz y los cuatro puntos de la revisión 2 ratificados sin reinterpretar; 20 premisas re-medidas (`decisiones.md` §1); **checkpoint abierto por autorización de commit** y **vigencia/consentimiento pendiente del operador** (necesario para H/E2E, no para G) |
