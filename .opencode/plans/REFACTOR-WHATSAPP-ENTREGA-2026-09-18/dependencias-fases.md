...
| QMind/write-back | **Actualizado por A (2026-09-19): la consulta quedó RECUPERADA** tras la denegación de la revisión 2; el aporte se registra en `evidence/…/FASE-A/qmind-consulta-reintentada.md` (6 filas: 3 ya cerradas en código vivo, 2 locales no capitalizadas, 1 dependencia nueva). **Upload sigue sin autorización** | Responsable documental/operador | La consulta no concede permiso de subida. Si se exige write-back, dejar checkpoint hasta autorización y comprobar contenido/frescura; SKIP por título no prueba actualización |
