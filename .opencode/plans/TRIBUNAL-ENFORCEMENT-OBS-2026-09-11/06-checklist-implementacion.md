...
**5/8 fases cerradas** (sin contar el predecesor ni VERIFY, que no está activa). P4 permanece cerrada. Orden restante: **P4 → FASE-P5 Seguridad y privacidad → FASE-P6 Generación y validación multi-hotel → RELEASE documental**. AC-V1 se ejecuta dentro de RELEASE, sin sesión VERIFY adicional.
...
| 5 | **FASE-P5 — Seguridad y privacidad** | Pendiente | — | — | Pendiente; presupuesto FUERA DE SERVICIO (R2.1/D-V2.1) | 4 tareas, 0 comandos largos, offline; AC-S1…AC-S4. Cierre técnico habilita P6, no publicación con pendientes externos sin resolución verificable o aceptación explícita del operador |
