...
> **Regla vigente (D-PRE.1, 2026-09-15)**: P4 permanece cerrada; P5 cerrada; **P6 cerrada + P6-R (remediación post-auditoría el mismo día)**; sigue **RELEASE**, ocho registros de ejecución cerrados sobre 8 fases (P6-R no es fase nueva, es la corrección de P6). RELEASE exige certificación técnica P5/P6 (ambas ✅) y la puerta de seguridad de AC-S4 resuelta; nombrar un dueño no resuelve un riesgo. El antiguo escenario de diferimiento de P4 se conserva solo como antecedente, no permite omitir las fases nuevas.
