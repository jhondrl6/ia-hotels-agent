...
> **Regla vigente (D-PRE.1, 2026-09-15)**: P4 permanece cerrada; P5 cerrada; siguen **P6 → RELEASE**, una fase por sesión, seis de ocho cerradas. RELEASE exige certificación técnica P5/P6 y la puerta de seguridad de AC-S4 resuelta; nombrar un dueño no resuelve un riesgo. El antiguo escenario de diferimiento de P4 se conserva solo como antecedente, no permite omitir las fases nuevas.
...
FASE-P5 ✅ (2026-09-15) — seguridad y privacidad; AC-S1…AC-S4  ← EJECUTADA:
        ...
        │ AC-S2 ✅ (checker ampliado a 13 extensiones + staged content, 3058 archivos escaneados),
