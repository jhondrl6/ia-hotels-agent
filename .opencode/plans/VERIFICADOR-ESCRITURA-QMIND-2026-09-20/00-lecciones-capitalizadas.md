...
| L-QW.4 | Un límite **conocido y escrito** no se cierra solo: esta restricción está documentada en el corpus desde 2026-09-11 y se redescubrió desde cero el 2026-09-20, porque ningún AC la reclamaba y ningún check la violaba. | el disparador, **AC6-entrega** y la sección §6 del maestro ⟦re-anclado el 2026-09-24: la lección apunta ahora al momento en que cada cosa se cierra, no a «AC6» como bloque indivisible. Es la misma cura que la L-AJUST.1 de arriba⟧ |
