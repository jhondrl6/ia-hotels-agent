...
|---|---|---|---|---|
| P0 | Commitear/empujar la corrección del punto 4 + re-anclajes (README, `09-documentacion`, `10-analisis`) | 3 archivos en el árbol, **sin commitear**; validadores en verde | Instrucción literal de commit (push aparte) | Higiene documental |
