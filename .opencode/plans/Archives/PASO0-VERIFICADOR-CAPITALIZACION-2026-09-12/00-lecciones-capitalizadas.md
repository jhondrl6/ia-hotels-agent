...
| Q7 | Repo (factibilidad de los checks propuestos, medida sobre el único artefacto real) | script ad-hoc: parsear la tabla §2 de `.opencode/plans/Archives/TRIBUNAL-ENFORCEMENT-OBS-2026-09-11/00-lecciones-capitalizadas.md` y confrontar cada ID contra el dueño de `.opencode/lecciones_index.json` | §2 tiene **18** filas · **18/18** dueños coinciden con el índice · **0** mal atribuidas · **0** sin definición · **6** dueños distintos (≥ 2 que exige C8) · **17** filas nombran un `AC-*` o una tarea. El umbral no está inflado: un artefacto humano real ya lo cumple |
