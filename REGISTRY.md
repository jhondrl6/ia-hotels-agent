...
| FASE-5 (ROICR) | 2026-05-27 | COMPLETADO | Fixtures financieros v4.3.0 + test_pricing_pipeline (18 tests) + 9 tests pre-existentes corregidos (min_price 800K). 518 tests pasando 0 failed. Archivos: tests/fixtures/financial_scenarios.json, tests/test_pricing_pipeline.py. v4_regression_guardian documentado como pre-existente. |
