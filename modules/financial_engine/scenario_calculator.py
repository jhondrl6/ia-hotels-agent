...
class ScenarioCalculator:
    ...
    def _calculate_conservative_scenario(
        ...
        minimal_improvement = scenario_config['ota_shift']['minimal']
    ...
    def _calculate_realistic_scenario(
        ...
        scenario_config = self._load_scenario_config()
        moderate_shift = scenario_config['ota_shift']['moderate']
    ...
    def _calculate_optimistic_scenario(
        ...
        scenario_config = self._load_scenario_config()
        optimistic_shift = scenario_config['ota_shift']['optimistic']
    ...
    def _get_shift_percentage(self, hotel_data: HotelFinancialData) -> float:
        ...
        try:
            ...
            return config['ota_shift']['moderate']
        except (YAMLLoadError, KeyError):
