...
class ReportBuilder:
    ...
    def _generate_resumen_ejecutivo(
        ...
        benchmark_referencia = f"GEO {geo_ref}/100 · AEO {aeo_ref}/100 ({region_label})"
...
"""
    ...
    def _generate_diagnostico_completo(
        ...
        geo_ref = region_profile.get('geo_score_ref', 60)
        aeo_ref = region_profile.get('aeo_score_ref', 40)
        benchmark_line = f"> Benchmark regional ({region_label}): GEO {geo_ref}/100 · AEO {aeo_ref}/100"
...
> Benchmark regional ({region_label}): GEO {geo_ref}/100 · SEO {web_ref}/100 · AEO {aeo_ref}/100
