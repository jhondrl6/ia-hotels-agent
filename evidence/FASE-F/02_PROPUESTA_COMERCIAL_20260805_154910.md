...
|----------|--------|-----------|----------------------|-------------|
| **SEO Local** | En proceso de activación — Semana 2 | 80% | #6: SEO Local Bajo ($899.000 COP/mes) | Para aparecer en las primeras posiciones de Google tradicional |
| **Botón de WhatsApp** | 📋 Auditoría incluida | — | Brecha #1: Conflicto de WhatsApp ($899.000 COP/mes) | Auditoría y Optimización de Conversión |
| **Schema Hotel** | ✅ Alineado | 100% | #3: Sin Schema Hotel ($1.123.390 COP/mes) | Datos estructurados para Google y IA sobre tu hotel |
| **Página de FAQ** | En proceso de activación — Semana 2 | 80% | #4: Sin Schema FAQ ($539.400 COP/mes) | Sus huéspedes encuentran respuestas sin salir de su web |
| **Meta Tags Sociales (Open Graph)** | ✅ Alineado | 100% | #10: Open Graph Tags Incompletos ($359.600 COP/mes) | Sus fotos brillan cuando alguien comparte su link en redes |
| **Optimización para IA Generativa** | ✅ Alineado | 100% | — | Aparece cuando clientes preguntan a ChatGPT/Gemini 'dónde hospedarme en [región]' |
...
- [ ] **Semana 2**: Implementación Fase 1 (WhatsApp + datos para IA): Hotel Schema, Review Plan, Whatsapp Button
- [ ] **Semana 3**: Implementación Fase 2 (Contenido y FAQs): Faq Page, Review Widget, Llms Txt
