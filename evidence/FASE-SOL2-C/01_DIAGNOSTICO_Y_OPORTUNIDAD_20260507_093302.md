---
generated_at: 2026-05-07 09:33:02
version: 4.0.0
hotel_id: termales
...
| **GEO** (Para que te UBIQUEN) | 80/100 | 89/100 | ❌ Bajo |
| **AEO** (Para que te CITEN) | 30/100 | 44/100 | ❌ Bajo |
| **IAO** (Para que te RECOMIENDEN) | 55/100 | 20/100 | ✅ Superior |
...
**AEO 30/100** = ✅ open_graph(15%) + ✅ imagenes_alt_aeo(15%)
...
| Citabilidad | 53.4/100 | 29 bloques | 🟢 |
| IA-Readiness | 68.1/100 | Needs Work | 🟢 |
...
✅ **Google Business Profile activo** — 22309 reviews, 4.6/5 rating
✅ **Redes sociales activas** — Facebook, Instagram

### Resumen de Visibilidad en IA

Visibilidad en IA: Media (estimado cualitativo). Senales: Schema Hotel: No detectado; Schema FAQ: Ausente; Contenido extenso para IA (citability: 53/100); Open Graph: Configurado
...
> ⚠️ **3 assets generados con confianza baja (< 0.7)** — Incluidos con disclaimer en el paquete de entrega. Ejecute onboarding con datos reales para mejorar la precisión.
...
| ChatGPT, Gemini y Perplexity no pueden "leer" su hotel. Perdida absoluta de rese... | +1,799,007/mes |
| Google no puede mostrar sus preguntas frecuentes en resultados. Competidores con... | +863,583/mes |
| Crawlers de IA bloqueados. Su hotel es invisible para ChatGPT y asistentes de IA... | +1,079,479/mes |
