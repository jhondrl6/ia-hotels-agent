---
generated_at: 2026-05-29 15:10:50
version: 4.59.0
...
# PROPUESTA COMERCIAL
## Hotelcastillareal - Cl 15 #12b-15, Pereira, Risaralda, Colombia

**Fecha**: 2026-05-29 15:10:50  
...
**Fuga mensual por comisiones OTA:** $3.741.696 COP (estimado)
...
| Métrica | Sin IAO (Status Quo) | Con IAO (Implementación) |
|----------|----------------------|--------------------------|
| Fuga mensual (pérdida) | $3.741.696 COP | — |
| Porción direccionable | 14% | 14% |
| Recuperación mensual | — | $178.235 COP |
| Inversión mensual | — | $400.000 COP |
| Beneficio mensual neto | — | $-221.765 COP |
| **Fuga anual (12 meses)** | $44.900.352 COP | — |
...
|----------|--------|-----------|----------------------|-------------|
| **SEO Local** | En proceso de activación — Semana 2 | 80% | #1: Sin Schema Hotel ($1,005,768/mes) | Para aparecer en las primeras posiciones de Google tradicional |
| **Botón de WhatsApp** | 📋 Auditoría incluida | — | Brecha #5: WhatsApp no coincide | Auditoría y Optimización de Conversión |
| **Schema Hotel** | ✅ Alineado | 100% | #1: Sin Schema Hotel ($1,005,768/mes) | Datos estructurados para Google y IA sobre tu hotel |
| **Schema Organization** | En proceso de activación — Semana 2 | 80% | #7: Sin Schema Org ($321,786/mes) | Datos estructurados sobre la organización del hotel |
| **Página de FAQ** | En proceso de activación — Semana 2 | 80% | #4: Sin FAQ ($482,679/mes) | Sus huéspedes encuentran respuestas sin salir de su web |
| **Meta Tags Sociales (Open Graph)** | ✅ Alineado | 100% | #6: Sin OG Tags ($321,786/mes) | Sus fotos brillan cuando alguien comparte su link en redes |
| **Optimización para IA Generativa** | ✅ Alineado | 100% | #3: Baja prep. IA ($603,536/mes) | Aparece cuando clientes preguntan a ChatGPT/Gemini 'dónde hospedarme en [región]' |
...
|------------|-------------------|-------------|
| Schema Hotel | ⚠️ Semana 1 (Con sus datos) | Requiere confirmacion post-firma |
| Schema Organization | ⚠️ Semana 1 (Con sus datos) | Requiere confirmacion post-firma |
| Página de FAQ | ⚠️ Semana 1 (Con sus datos) | Requiere confirmacion post-firma |
| Meta Tags Sociales (Open Graph) | ✅ Día 1 (Activación inicial) | Listo para implementar |
| Optimización para IA Generativa | ✅ Día 1 (Activación inicial) | Listo para implementar |
...
|-----|----------|----------------------|-----------|
| 1 | $400.000 COP | $196.439 COP | $-203.561 COP |
| 2 | $400.000 COP | $458.357 COP | $58.357 COP |
| 3 | $400.000 COP | $785.756 COP | $385.756 COP |
| 4 | $400.000 COP | $1.047.674 COP | $647.674 COP |
| 5 | $400.000 COP | $1.244.113 COP | $844.113 COP |
| 6 | $400.000 COP | $1.309.593 COP | $909.593 COP |

**Nota de proyección**: La inversión mensual de $400,000 COP representa solo el 10.7% de su fuga mensual estimada ($3,741,696). El otro 89.3% seguiría perdiéndose cada mes si no implementamos el Kit 4 Pilares.

> 📊 **Trazabilidad financiera**: La fuga total estimada es de $22.450.176 COP en 6 meses.
> Con nuestro servicio, la recuperación proyectada es de $5.041.935 COP.
> **Origen**: Fuga mensual ($3,741,696) × Curva de Maduración 4 Pilares (GEO→SEO→AEO→IAO) × Recovery Factor 35%.
...
|-----|-----------|-------------|-----------|-------|
| Mes 1 | 15% | $196.439 | $196.439 | GEO — Google Business Profile, visibilidad local inmediata |
| Mes 2 | 35% | $458.358 | $654.797 | SEO — Indexación, rich snippets, datos estructurados |
| Mes 3 | 60% | $785.756 | $1.440.553 | SEO — Autoridad de dominio, backlinks, contenido |
| Mes 4 | 80% | $1.047.675 | $2.488.228 | AEO — Answer Engine Optimization (ChatGPT, Gemini, Perplexity) |
| Mes 5 | 95% | $1.244.114 | $3.732.342 | IAO — IA Optimization, maduración completa del ecosistema |
| Mes 6 | 100% | $1.309.594 | $5.041.935 | IAO — Estado estacionario, mantenimiento y optimización continua |

**Total recuperación proyectada (6 meses): $5.041.935 COP**
...
| Desglose CAPEX | | | Componente | Monto | Descripción |
|---|---|---|
...
| **Total CAPEX** | **$2.500.000 COP** | Única vez | | Detalle del activo |
...
> **ROI SaaS (servicio): 2.10X** — calculado solo sobre OPEX (fee de servicio), sin mezclar el activo digital que es suyo.
...
- [ ] **Semana 2**: Implementación Fase 1 (WhatsApp + datos para IA): Hotel Schema, Optimization Guide, Whatsapp Button
- [ ] **Semana 3**: Implementación Fase 2 (Contenido y FAQs): Faq Page, Llms Txt, Local Content Page
...
- [ ] **Días 46-50**: Implementación Fase 3 (Guías locales): Org Schema
...
- [ ] **Días 81-85**: Planificación fase 2 basada en gaps: Org Schema
