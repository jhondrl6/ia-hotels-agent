---
generated_at: 2026-07-30 14:37:15
version: 4.66.0
hotel_id: zione
...
**Fuga mensual neta estimada (después de acciones recomendadas):** $7.192.000 COP/mes
>
...
| Métrica | Valor |
|---------|-------|
| ADR regional promedio | $290,000 COP |
...
**Inversión: $500.000 COP/mes** (contrato mes a mes)
...
> **Servicios adicionales disponibles:** Schema Organization
...
> **⚠️ Advertencia:** Nivel de evidencia: A. Estas proyecciones usan benchmarks regionales. Para precisión exacta, ejecute el onboarding con datos reales.
...
|-----|----------|----------------------|-----------|
| 1 | $500.000 COP | $377.580 COP | $-122.420 COP |
| 2 | $500.000 COP | $881.020 COP | $381.020 COP |
| 3 | $500.000 COP | $1.510.320 COP | $1.010.320 COP |
| 4 | $500.000 COP | $2.013.760 COP | $1.513.760 COP |
| 5 | $500.000 COP | $2.391.340 COP | $1.891.340 COP |
| 6 | $500.000 COP | $2.517.200 COP | $2.017.200 COP |

**Nota de proyección**: La inversión mensual de $500,000 COP representa solo el 7.0% de su fuga mensual estimada ($7,192,000). El otro 93.0% seguiría perdiéndose cada mes si no implementamos el Kit 4 Pilares.

> 📊 **Trazabilidad financiera**: La fuga total estimada es de $43.152.000 COP en 6 meses.
> Con nuestro servicio, la recuperación proyectada es de $9.691.220 COP.
> **Origen**: Fuga mensual ($7,192,000) × Curva de Maduración 4 Pilares (GEO→SEO→AEO→IAO) × Recovery Factor 35%.
...
|-----|-----------|-------------|-----------|-------|
| Mes 1 | 15% | $377.580 | $377.580 | GEO — Google Business Profile, visibilidad local inmediata |
| Mes 2 | 35% | $881.020 | $1.258.600 | SEO — Indexación, rich snippets, datos estructurados |
| Mes 3 | 60% | $1.510.320 | $2.768.920 | SEO — Autoridad de dominio, backlinks, contenido |
| Mes 4 | 80% | $2.013.760 | $4.782.680 | AEO — Answer Engine Optimization (ChatGPT, Gemini, Perplexity) |
| Mes 5 | 95% | $2.391.340 | $7.174.020 | IAO — IA Optimization, maduración completa del ecosistema |
| Mes 6 | 100% | $2.517.200 | $9.691.220 | IAO — Estado estacionario, mantenimiento y optimización continua |

**Total recuperación proyectada (6 meses): $9.691.220 COP**
...
| Fee mensual (×6) | **OPEX** | $3.000.000 COP | Servicio de implementación |

Los $2.500.000 COP del setup fee representan activos digitales que quedan en propiedad del cliente (Real Estate Digital). El ROI se calcula sobre la inversión operativa ($3.000.000 COP / 6 meses). no sobre OPEX+CAPEX combinados.
...
> **ROI SaaS (servicio): 3.23X** — calculado solo sobre OPEX (fee de servicio), sin mezclar el activo digital que es suyo.
...
- [ ] **Semana 2**: Implementación Fase 1 (WhatsApp + datos para IA): Hotel Schema, Whatsapp Button, Whatsapp Conflict Guide
- [ ] **Semana 3**: Implementación Fase 2 (Contenido y FAQs): Faq Page, Llms Txt, Optimization Guide
...
### 🔴 Oportunidad Urgente para Zione

Su hotel puede recuperar **$1.615.203 COP mensuales** con una inversión que se paga sola en **2 meses** (ROICR: 3.23x).
