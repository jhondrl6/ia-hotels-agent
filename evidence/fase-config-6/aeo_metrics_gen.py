...
MOTIVO: No hay caller en el pipeline. La generación de métricas AEO
  se hace vía PainSolutionMapper y OpportunityScorer directamente.
...
warnings.warn(
    ...
    "La generación de métricas AEO se hace vía PainSolutionMapper y "
    "OpportunityScorer directamente. Se eliminará en v5.0.0.",
    DeprecationWarning,
    stacklevel=2
)
