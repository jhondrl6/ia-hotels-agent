---
generated_at: 2026-05-28 15:10:28
version: 4.56.0
hotel_id: hotel_castilla_real
coherence_score: 0.8261538461538461
gate_status: PASSED
...
# 🚨 DIAGNÓSTICO DIGITAL
## Hotel Castilla Real - Cl 15 #12b-15, Pereira, Risaralda, Colombia

**Fecha**: 2026-05-28 15:10:28  
...
> Su Google Business muestra **310 4692201**, pero su sitio web indica **6063332192**. Cada cliente que intenta reservar por WhatsApp desde Google podría estar escribiendo al número equivocado.
...
### [BRECHA 6] Sin Meta Tags Sociales (Open Graph)
- **Detalle:** Cuando alguien comparte su hotel en WhatsApp/Facebook, aparece sin imagen ni descripcion atractiva.
- **Por que importa:** 8%
- **Costo:** $321.786 COP/mes

### [BRECHA 7] Sin Schema Organization (Entidad no verificable)
...
| **GEO** (Para que te UBIQUEN) | 70/100 | 89/100 | ❌ Bajo |
| **AEO** (Para que te CITEN) | 0/100 | 44/100 | ❌ Bajo |
| **IAO** (Para que te RECOMIENDEN) | 25/100 | 20/100 | ✅ Superior |
...
✅ **Google Business Profile activo** — 534 reviews, 4.6/5 rating
✅ **Redes sociales activas** — Instagram, Facebook, YouTube

### Resumen de Visibilidad en IA

Visibilidad en IA: Baja (estimado cualitativo). Senales: Schema Hotel: No detectado; Schema FAQ: Ausente; Contenido extenso para IA (citability: 57/100); Open Graph: No configurado
...
| ChatGPT, Gemini y Perplexity no pueden "leer" su hotel. Pérdida absoluta de rese... | +1,005,768/mes (Fuga mensual estimada) |
| Titulo y descripcion usan valores por defecto. | +402,232/mes (Fuga mensual estimada) |
| El contenido no está optimizado para ser citado por asistentes de IA. | +603,536/mes (Fuga mensual estimada) |
| Google no puede mostrar sus preguntas frecuentes en resultados. Competidores con... | +482,679/mes (Fuga mensual estimada) |
| No se detectó robots.txt ni llms.txt. Los asistentes de IA no tienen un mapa cla... | +603,536/mes (Fuga mensual estimada) |
| Cuando alguien comparte su hotel en WhatsApp/Facebook, aparece sin imagen ni des... | +321,786/mes (Fuga mensual estimada) |
| No se detecta markup de schema.org/Organization. Entidad no verificable por IA. | +321,786/mes (Fuga mensual estimada) |
