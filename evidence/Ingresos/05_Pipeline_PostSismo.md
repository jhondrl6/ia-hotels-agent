...
- [x] ~~Llamada a #1 Condina para decidir inclusión o archivo.~~ **CERRADO 29-08 in situ: NO OPERATIVO** (afectado por el terremoto) → excluido, re-evaluar 90+ días (2026-11-29). Reemplazado en el top 10 por Finca Hotel Don Julio (Santa Rosa de Cabal).
