---
generated_at: 2026-05-02 20:33:53
version: 4.0.0
hotel_id: hotelcastillareal
coherence_score: 0.8466666666666666
...
financial_opportunity_cost: $2.610.000 COP
financial_ota_commission_real: $5.400.000 COP
...
**$2.610.000 COP/mes *(estimado — Tier C)***

Desglose:
- Estimación basada en escenario meta esperada
- Fuente del dato: benchmark
- Comisión OTA real (verificable): $5.400.000 COP/mes
...
> ⚠️ **12 assets generados con confianza baja (< 0.7)** — Incluidos con disclaimer en el paquete de entrega. Ejecute onboarding con datos reales para mejorar la precisión.
...
| Conservador | $5.076.000 COP/mes | 70% |
| Realista | $2.610.000 COP/mes | 20% |
| Optimista | $-189.000 COP/mes | 10% |

**Proyección 6 meses:** $15.660.000 COP
...
- **Pérdida acumulada:** $15.660.000 COP
...
| ChatGPT, Gemini y Perplexity no pueden "leer" su hotel. Perdida absoluta de rese... | +701,568/mes |
| Titulo y descripcion usan valores por defecto. | +280,575/mes |
| El contenido no está optimizado para ser citado por asistentes de IA. | +420,993/mes |
| Google no puede mostrar sus preguntas frecuentes en resultados. Competidores con... | +336,690/mes |
| Crawlers de IA bloqueados. Su hotel es invisible para ChatGPT y asistentes de IA... | +420,993/mes |
| Cuando alguien comparte su hotel en WhatsApp/Facebook, aparece sin imagen ni des... | +224,460/mes |
| No se detecta markup de schema.org/Organization. Entidad no verificable por IA. | +224,460/mes |
