...
NICHO Y MERCADO: Hoteles boutique independientes (10-25 habitaciones), Eje Cafetero, Colombia. ADR regional: $280K COP (benchmark maestro v1.1.0, calibrado vs observaciones Tier A). Ocupación: 51.2%. Comisiones OTA: 15-25% por reserva. Competencia regional: scores de visibilidad digital 2-3× superiores al cliente típico (GEO 77/100 vs 61/100; SEO 59 vs 25). Fuente: `data/benchmarks/regional_adr_2026.json`.
