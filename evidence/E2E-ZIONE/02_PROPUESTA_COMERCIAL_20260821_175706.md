...
**Fuga mensual neta estimada (después de acciones recomendadas):** $13.456.000 COP/mes
>
...
|----------|--------|-----------|----------------------|-------------|
| **SEO Local** | En proceso de activación — Semana 2 | 80% | #3: SEO Local Bajo ($2.691.200 COP/mes) | Para aparecer en las primeras posiciones de Google tradicional |
| **Schema Hotel** | ✅ Alineado | 100% | #1: Sin Schema Hotel ($3.364.000 COP/mes) | Datos estructurados para Google y IA sobre tu hotel |
| **Página de FAQ** | En proceso de activación — Semana 2 | 80% | #2: Sin Schema FAQ ($1.614.720 COP/mes) | Sus huéspedes encuentran respuestas sin salir de su web |
| **Meta Tags Sociales (Open Graph)** | ✅ Alineado | 100% | #7: Open Graph Tags Incompletos ($1.076.480 COP/mes) | Sus fotos brillan cuando alguien comparte su link en redes |
...
> **Servicios adicionales disponibles:** Botón de WhatsApp, Schema Organization
...
|-----|----------|----------------------|-----------|
| 1 | $500.000 COP | $706.440 COP | $206.440 COP |
| 2 | $500.000 COP | $1.648.360 COP | $1.148.360 COP |
| 3 | $500.000 COP | $2.825.760 COP | $2.325.760 COP |
| 4 | $500.000 COP | $3.767.680 COP | $3.267.680 COP |
| 5 | $500.000 COP | $4.474.120 COP | $3.974.120 COP |
| 6 | $500.000 COP | $4.709.600 COP | $4.209.600 COP |

**Nota de proyección**: La inversión mensual de $500,000 COP representa solo el 3.7% de su fuga mensual estimada ($13,456,000). El otro 96.3% seguiría perdiéndose cada mes si no implementamos el Kit 4 Pilares.

> 📊 **Trazabilidad financiera**: La fuga total estimada es de $80.736.000 COP en 6 meses.
> Con nuestro servicio, la recuperación proyectada es de $18.131.960 COP.
> **Origen**: Fuga mensual ($13,456,000) × Curva de Maduración 4 Pilares (GEO→SEO→AEO→IAO) × Recovery Factor 35%.
...
|-----|-----------|-------------|-----------|-------|
| Mes 1 | 15% | $706.440 | $706.440 | GEO — Google Business Profile, visibilidad local inmediata |
| Mes 2 | 35% | $1.648.360 | $2.354.800 | SEO — Indexación, rich snippets, datos estructurados |
| Mes 3 | 60% | $2.825.760 | $5.180.560 | SEO — Autoridad de dominio, backlinks, contenido |
| Mes 4 | 80% | $3.767.680 | $8.948.240 | AEO — Answer Engine Optimization (ChatGPT, Gemini, Perplexity) |
| Mes 5 | 95% | $4.474.120 | $13.422.360 | IAO — IA Optimization, maduración completa del ecosistema |
| Mes 6 | 100% | $4.709.600 | $18.131.960 | IAO — Estado estacionario, mantenimiento y optimización continua |

**Total recuperación proyectada (6 meses): $18.131.960 COP**
...
> **ROI SaaS (servicio): 5.00X** — calculado solo sobre OPEX (fee de servicio), sin mezclar el activo digital que es suyo.
...
Su hotel puede recuperar **$3.021.993 COP mensuales** con una inversión que se paga sola en **1 meses** (ROICR: 6.04x).
