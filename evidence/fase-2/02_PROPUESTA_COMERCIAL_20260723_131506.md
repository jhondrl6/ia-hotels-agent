---
generated_at: 2026-07-23 13:15:06
version: 4.62.0
hotel_id: zi_one_luxury
...
# PROPUESTA COMERCIAL
## Zi One Luxury - Cra. 13 #12- 28, Pereira, Risaralda, Colombia

**Fecha**: 2026-07-23 13:15:06  
...
**Fuga mensual por comisiones OTA:** $7.192.000 COP (estimado)
...
|----------|--------|-----------|----------------------|-------------|
| **SEO Local** | ⏳ Pendiente | — | #1: Sin Schema Hotel ($1,005,768/mes) | Para aparecer en las primeras posiciones de Google tradicional |
...
| **Meta Tags Sociales (Open Graph)** | ⏳ Pendiente | — | #6: Sin OG Tags ($321,786/mes) | Sus fotos brillan cuando alguien comparte su link en redes |
...
- [ ] **Semana 3**: Implementación Fase 2 (Contenido y FAQs): Faq Page, Llms Txt, Analytics Setup Guide
...
### 🔴 Oportunidad Urgente para Zi One Luxury
