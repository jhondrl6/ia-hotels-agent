...
class AnalyticsStatus:
    ...
    def is_complete(self) -> bool:
        ...
        return self.ga4_available and self.profound_available and self.semrush_available

    def is_any_missing(self) -> bool:
        """True si ALGUNA fuente no esta disponible."""
        return not self.ga4_available or not self.profound_available or not self.semrush_available
    ...
    def summary_for_template(self) -> str:
        ...
        Ejemplo:
        "GA4: No configurado (falta credentials). | Profound AI: No disponible
        en esta version. | Semrush SEO: No disponible en esta version."
        """
        parts: list[str] = []
